...
Last verified: 2026-05-07 with `git diff --check` and full VS Code test run (`120 passed`; hosted-provider UserTesting skipped unless fixture env is configured).
