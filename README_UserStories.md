...
Last verified: 2026-04-27 with `git diff --check && python3 -m pytest -v` (`70 passed`).
...
1. US-007 hardening: add Git SHA format validation, SVN branch path normalization, SVN merge limitation reporting, and Git-only condition skipping.
