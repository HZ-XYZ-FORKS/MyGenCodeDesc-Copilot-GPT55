...
Last verified: 2026-05-07 with `git diff --check` and full VS Code test run (`120 passed`).
...
3. Broader real-repository hardening: add provider-backed AlgA/AlgC fixtures, SVN merge-history blame fixtures, hosted outage simulations, and reference-scale benchmarks beyond synthetic local repositories.
