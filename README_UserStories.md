...
Last verified: 2026-05-07 with `git diff --check` and full VS Code test run (`121 passed`; hosted-provider UserTesting skipped unless fixture env is configured).
